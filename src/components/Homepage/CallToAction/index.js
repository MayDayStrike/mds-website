...
import * as CTAModule from "./CTA.module.css"
...
const CallToAction = () => {
  ...
  return (
    <div className={CTAModule.container}>
      <Modal
        isOpen={show}
        onAfterOpen={null}
      ...
      <p>
        Join us on Discord and social media to become part of the new era of
        labor organization in the United States and across the globe.
      </p>
      <p>
        Sign up for the May Day Newsletter to stay informed about progress,
        requests, and future events!
      </p>
      <button
